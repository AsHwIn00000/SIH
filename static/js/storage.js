...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'hexa-model-expanded',
  MODEL_ENDPOINTS: 'hexa-model-endpoints',
  MODEL_SELECTED: 'hexa-selected-model',
  SORT_ORDER: 'hexa-sessions-sort',
  CHAT_SEARCH_SCOPE: 'hexa-search-scope',
  INCOGNITO: 'hexa-incognito',
  RAG_ACTIVE: 'hexa-rag-active',
  MCP_ACTIVE: 'hexa-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'hexa-density',
  UI_SCALE: 'hexa-ui-scale',
  WORKSPACE: 'hexa-workspace'
};
